...
@export var animations_storage : AnimationPlayer
...
var previous_animation_progress : float = 0

var is_blending : bool = false
var blend_duration : float
var blend_time_spent : float
var blending_percentage : float

var last_processing_time : float = 0
var delta : float = 0
var now : float = 0

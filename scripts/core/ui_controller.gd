...
func _update_weapon_selected_style() -> void:
	...
	UiUtils.reset_button_style(weapon_one)
	UiUtils.reset_button_style(weapon_two)

	match _selected_weapon_slot:
		WeaponSlot.ONE:
			UiUtils.apply_selected_style(weapon_one, selected_color)
		WeaponSlot.TWO:
			UiUtils.apply_selected_style(weapon_two, selected_color)
